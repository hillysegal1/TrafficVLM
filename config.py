...
# Global settings
_C.GLOB = CN()
_C.GLOB.EXP_PARENT_DIR = "/content/traffic_vlm_logs"
_C.GLOB.SEED = 42
_C.GLOB.DEVICE = "cpu"
...
_C.MODEL.T5_PATH = "t5-base"  # Path to T5 model
_C.MODEL.EMBED_DIM = 768
_C.MODEL.DEPTH = 12
_C.MODEL.NUM_HEADS = 12
_C.MODEL.MLP_DIM = 2048
_C.MODEL.VIS_DROP = 0.1
_C.MODEL.FEATURE_BRANCHES = ["global"]  # Options like ["vehicle", "overhead", "mix"]
...
_C.MODEL.VID2SEQ_PATH = "/content/vid2seq_checkpoint.pth"
_C.MODEL.LOAD_VID2SEQ_CKPT = True

# Solver configurations
_C.SOLVER = CN()
_C.SOLVER.LOAD_FROM_EPOCH = -1
_C.SOLVER.LOAD_FROM_PATH = '/content/traffic_vlm_checkpoint.pth'
...
_C.SOLVER.TRAIN.CLIP_MAX_NORM = 1.0
...
_C.SOLVER.TRAIN.OPTIMIZER.WEIGHT_DECAY = 0.0
...
_C.SOLVER.VAL.REPETITION_PENALTY = 1.0
_C.SOLVER.VAL.LENGTH_PENALTY = 1.0
_C.SOLVER.VAL.TEMPERATURE = 0.0

_C.SOLVER.TEST = CN()
_C.SOLVER.TEST.NUM_BEAMS = 4
_C.SOLVER.TEST.TOP_P = 0.9
_C.SOLVER.TEST.REPETITION_PENALTY = 1.0
_C.SOLVER.TEST.LENGTH_PENALTY = 1.0
_C.SOLVER.TEST.TEMPERATURE = 1.0
...
def convert_to_dict(cfg_node, key_list=[]):
    """Convert a config node to a nested dictionary."""
...
def get_sig(cfg_dict):
    """Generate a signature hash from a dictionary."""
    import json
